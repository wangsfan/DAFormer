...
from continual import samplers, vit, DualVit, dual
from continual.cnn import (InceptionV3, resnet18, resnet34, resnet50,
                           resnext50_32x4d, seresnet18, vgg16, vgg16_bn,
                           wide_resnet50_2, resnet18_scs, resnet18_scs_max,
                           resnet18_scs_avg, resnet_rebuffi)
...
def get_backbone(args):
    ...
    elif args.model == 'DualVit':
        model = DualVit.DualVit(
            num_classes=args.nb_classes,
            drop_rate=args.drop,
            drop_path_rate=args.drop_path,
            img_size=args.input_size,
    ...
    elif args.model == 'resnet18_scs':
        model = resnet18_scs()
    elif args.model == 'resnet18_scs_avg':
        model = resnet18_scs_max()
    elif args.model == 'resnet18_scs_max':
        model = resnet18_scs_avg()
    elif args.model == 'resnet18' or args.model == 'hypercnn':
        model = resnet18()
...
def update_dual(model_without_ddp, task_id, args):
    if task_id == 0:
        print(f'Creating DualVit!')
        model_without_ddp = dual.Dual(
            model_without_ddp,
